...
export function CampaignShareEditorial({ shareUrl, shareBody }: Props) {
  ...
  return (
    <div
      className="rounded-[20px] border border-[rgba(10,128,128,0.15)] bg-[var(--color-background)] p-6"
      style={{ boxShadow: "0 2px 8px rgba(10, 128, 128, 0.06)" }}
    >
      <div
