---
title: "The Single Injection That Could End the Cyprus Cat Crisis — And Why No One Is Talking About It"
slug: "single-injection-end-cyprus-cat-crisis"
date: "2026-03-24"
author: "Tinies"
category: "Solutions"
categories: ["Solutions", "Science", "Cyprus Cat Crisis"]
excerpt: "A gene therapy contraceptive developed by Harvard and the Cincinnati Zoo permanently sterilizes female cats with one injection. No surgery. No anesthesia. No vet required. Cyprus has not pursued it."
image: "/images/blog/cat-injection-gene-therapy.jpg"
---

Cyprus sterilizes approximately 2,000 cats per year. The island's [stray cat population is estimated at one million](/blog/why-cyprus-has-15-million-stray-cats), with some activists placing the figure significantly higher. At the current rate, it would take five hundred years to sterilize the existing population — assuming no new cats were born in the interim.

The [government recently tripled the sterilization budget](/blog/cyprus-government-stray-animal-spending) to €300,000 annually. This was celebrated as a breakthrough. It is not. It is a rounding error applied to a crisis that compounds daily.

The math is not complicated. Surgical sterilization requires a trained veterinarian, anesthesia, a sterile facility, and post-operative recovery time. Each procedure costs between €50 and €120 depending on the clinic. At €300,000, the island can fund between 2,500 and 6,000 surgeries per year. Peer-reviewed population models consistently show that unless [at least 70 percent of a feral cat population is sterilized](https://pmc.ncbi.nlm.nih.gov/articles/PMC9169806/) within a narrow timeframe, the population does not decline. It stabilizes or rebounds. For Cyprus, 70 percent means sterilizing somewhere between 700,000 and 1.4 million cats. The current system cannot do this. It was never designed to do this.

But something exists that could.

## What the Research Shows

In June 2023, a team led by [David Pépin](https://www.pepinlab.com/david-pepin) at Harvard and [William Swanson](https://cincinnatizoo.org/conservation/crew/crew-scientists/) at the Cincinnati Zoo published a study in [Nature Communications](https://www.nature.com/articles/s41467-025-65780-2) describing a single-dose injectable contraceptive for female cats. The treatment uses an adeno-associated viral vector to deliver a feline anti-Müllerian hormone transgene directly into muscle tissue. One injection into the thigh causes the cat's muscle cells to produce elevated levels of AMH, a naturally occurring hormone that prevents ovulation.
...
The [Michelson Found Animals Foundation](https://www.michelsonprizeandgrants.org/), which funded the research, has offered a $25 million prize for the development of a single-treatment nonsurgical sterilization method for cats and dogs. The AMH gene therapy is the most promising candidate to date.
...
A [12-year controlled field study published in PNAS](https://www.pnas.org/doi/10.1073/pnas.2119000119) found that TNR programs only reduce populations when applied at high intensity across contiguous geographic areas. Fragmented, low-intensity efforts — which is [exactly what Cyprus has been doing](/blog/what-happens-stray-cats-cyprus-no-intervention) — produce minimal or no population reduction and can even be counterproductive by improving kitten survival rates without sufficiently reducing births.

An injectable contraceptive would allow Cyprus to run contiguous, high-intensity campaigns [district by district](/blog/eradicate-by-district-cyprus-cat-strategy), covering entire municipalities in weeks rather than years.

## What Would It Take

The gene therapy contraceptive is not yet commercially available. It remains in the research phase, with larger trials needed to confirm long-term safety and efficacy. Regulatory approval through the [European Medicines Agency](https://www.ema.europa.eu/) would be required before deployment in the EU.
...
The Cyprus cat crisis is not unique. It is a concentrated version of a global problem. An estimated 600 million cats live without permanent homes worldwide. Approximately [80 percent of the global cat population is free-roaming](https://pmc.ncbi.nlm.nih.gov/articles/PMC10854515/). Surgical sterilization has been the primary tool for decades and has not solved the problem anywhere at national scale.

If a single-injection contraceptive can be proven safe, effective, and affordable, it changes [feral cat management globally](/blog/mediterranean-stray-cat-scorecard). Cyprus, by virtue of its island geography and the severity of its crisis, is the natural proving ground.
