---
title: "The Cause Hotel: What I Pitched, What Y Combinator Said, and What I Think Now"
slug: "the-cause-hotel-yc-pitch-what-we-think-now"
excerpt: "I pitched a franchise model where hotels funded animal sanctuaries. Y Combinator passed. Here is what I built instead — and why I think the original idea was early rather than wrong."
category: "Business & Platform"
categories: ["Business & Platform"]
date: "2026-03-26"
seoDescription: "From Cause Hotel at YC to Tinies — why hospitality-plus-sanctuary was “unfundable” as software-scale, and why a certification network might still be the right shape."
...
I built [Tinies](https://tinies.app) — a pet services marketplace where the booking commission funds animal sanctuaries directly. [Approximately 90% of every commission goes to rescue operations](/blog/tinies-model-booking-fee-funds-sanctuary), starting with [Gardens of St. Gertrude](https://gardensofstgertrude.com), the sanctuary I founded in Parekklisia, Cyprus, which currently cares for 92 cats.

Tinies is, in structural terms, the same architecture as Cause Hotel applied to a different format. The commercial transaction funds the mission. The mission gives the commercial layer its identity and its reason to exist. The revenue commitment is structural, not discretionary. [The mission is not a marketing layer. It is load-bearing.](/blog/not-trying-to-get-rich)
...
[The problem this series has been examining](/blog/the-bleeding-cost-of-running-cat-sanctuary-cyprus) is not solvable by a marketplace alone. Tinies can generate revenue that funds sanctuaries. It cannot provide the sanctuaries themselves — the physical infrastructure, the enclosed land, the safe environment that keeps 92 cats protected from traffic and hostile neighbors and the hundred other threats that face a stray animal in Cyprus.
...
[Cyprus has the raw material](/blog/what-if-the-land-paid-for-itself): distressed rural properties, an ancient relationship with cats, a tourism sector that has not yet figured out what its differentiating identity is, and a community of animal welfare operators who are currently running on sacrifice rather than structure.
...
*Next in this series: [The 90% model](/blog/the-90-percent-model) — how to structure any business so that animal welfare is the point, not the afterthought.*

---

[Tinies](https://tinies.app) is a pet services marketplace built to fund animal sanctuaries across Cyprus. [Gardens of St. Gertrude](https://gardensofstgertrude.com) is the sanctuary it was built to sustain.
