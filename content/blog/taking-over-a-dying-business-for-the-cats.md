---
title: "Taking Over a Dying Business for the Cats"
slug: "taking-over-a-dying-business-for-the-cats"
excerpt: "Cyprus has distressed rural properties, European financing mechanisms, and a stray animal crisis that nobody is solving with donations alone. The acquisition model is more achievable than it sounds."
...
*Next in this series: [The Cause Hotel — what happened when we tried to build this at scale, and what we think now.](/en/blog/the-cause-hotel-yc-pitch-what-we-think-now)*

---

[Tinies](https://tinies.app) is a pet services marketplace committed to funding animal welfare in Cyprus. [Read about how the booking commission model works](/en/blog/tinies-model-booking-fee-funds-sanctuary) — and why we built it this way instead of asking for donations.
